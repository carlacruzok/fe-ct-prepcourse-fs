...
function crearUsuario() {
   ...
   function Usuario(usuario, nombre, email, password){
      ...
      } //saludar(){ con la propiedad prototype enlazo el metodo con la clase
         Usuario.prototype.saludar = function(){
         return 'Hola, mi nombre es ' + this.nombre;
      }
      //Si queremos usar esta plantilla, instanciamos la clase
      // var usuario = new Usuario('Jodannys', 'Jodannys','Jodannys@mail.com', 'pass123')   
      // console.log(usuario)
      return Usuario;
   } 
//crearUsuario()
...
// OTRA FORMA
    //String.prototype.reverse=function() {
      //var stringInvertida = '';
      //for (var i = this.length-1; i>= 0; 1--){
        // stringInvertida = stringInvertida + this.charAt(i) // charAt devuelve la posicion en la que se encuentra
     // }
